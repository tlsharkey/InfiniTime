...
#include "displayapp/screens/Marker.h"
...
void DisplayApp::LoadApp(Apps app, DisplayApp::FullRefreshDirections direction) {
  ...
  switch (app) {
    ...
    case Apps::Twos:
      ...
      break;
    case Apps::Paint:
      currentScreen = std::make_unique<Screens::InfiniPaint>(this, motionController, lvgl);
      break;
    case Apps::Paddle:
    ...
    case Apps::Metronome:
      ...
      break;
    case Apps::Marker:
      currentScreen = std::make_unique<Screens::Marker>(this);
      break;
    case Apps::Motion:
